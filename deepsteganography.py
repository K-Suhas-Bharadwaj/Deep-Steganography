# -*- coding: utf-8 -*-
"""DeepSteganography.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YG9lGlC_Nr6SD7Tlvf9IGCPRA96WQvf6
"""
...
MODELS_PATH = os.path.abspath("D:/Downloads/dataset/output/models/")
# TRAIN_PATH = cwd+'/train/'
# VALID_PATH = cwd+'/valid/'
print(MODELS_PATH)
VALID_PATH = os.path.abspath("D:/Downloads/dataset/sample/valid/")
TRAIN_PATH = os.path.abspath("D:/Downloads/dataset/sample/train/")
TEST_PATH = os.path.abspath("D:/Downloads/dataset/test/")
